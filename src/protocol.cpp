...
static unsigned char pchMessageStartTestNew[4] = { 0x8f, 0x7d, 0x6c, 0x9a };
static unsigned int nMessageStartTestSwitchTime = 0;

// Peercoin message start (switch from Bitcoin's in v0.2)
static unsigned char pchMessageStartBitcoin[4] = { 0xf9, 0xbe, 0xb4, 0xd9 };
static unsigned char pchMessageStartPeercoin[4] = { 0xea, 0xfc, 0xa9, 0x6c };
static unsigned int nMessageStartSwitchTime = 0;

unsigned char pchMessageStart[4] = { 0xea, 0xfc, 0xa9, 0x6c };
