...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("EAT");
    case mBTC: return QString("mEAT");
    case uBTC: return QString::fromUtf8("uEAT");
...
QString BitcoinUnits::description(int unit)
{
    ...
    {
    case BTC: return QString("EAT");
    case mBTC: return QString("Milli-EAT(1 / 1,000)");
    case uBTC: return QString("Micro-EAT(1 / 1,000,000)");
    default: return QString("???");
    }
}
